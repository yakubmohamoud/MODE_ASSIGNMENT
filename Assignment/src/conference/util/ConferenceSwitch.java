...
public class ConferenceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ConferencePackage.TABLE: {
				Table table = (Table)theEObject;
				T result = caseTable(table);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.SEAT: {
				Seat seat = (Seat)theEObject;
				T result = caseSeat(seat);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.ATTENDEE: {
				Attendee attendee = (Attendee)theEObject;
				T result = caseAttendee(attendee);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.CHOICE: {
				Choice choice = (Choice)theEObject;
				T result = caseChoice(choice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.SUBJECT: {
				Subject subject = (Subject)theEObject;
				T result = caseSubject(subject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.ALLERGIE: {
				Allergie allergie = (Allergie)theEObject;
				T result = caseAllergie(allergie);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.LANGUAGE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Attendee</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Attendee</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAttendee(Attendee object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Allergie</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Allergie</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAllergie(Allergie object) {
		return null;
	}
