...
public class ConferenceFactoryImpl extends EFactoryImpl implements ConferenceFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ConferencePackage.TABLE: return createTable();
			case ConferencePackage.SEAT: return createSeat();
			case ConferencePackage.ATTENDEE: return createAttendee();
			case ConferencePackage.CHOICE: return createChoice();
			case ConferencePackage.SUBJECT: return createSubject();
			case ConferencePackage.ALLERGIE: return createAllergie();
			case ConferencePackage.LANGUAGE: return createLanguage();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ConferencePackage.CHOICES:
				return createChoicesFromString(eDataType, initialValue);
			case ConferencePackage.SUBJECTS:
				return createSubjectsFromString(eDataType, initialValue);
			case ConferencePackage.ALLERGIES:
				return createAllergiesFromString(eDataType, initialValue);
			case ConferencePackage.TITLE:
				return createTitleFromString(eDataType, initialValue);
			case ConferencePackage.LANGUAGES:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ConferencePackage.SUBJECTS:
				return convertSubjectsToString(eDataType, instanceValue);
			case ConferencePackage.ALLERGIES:
				return convertAllergiesToString(eDataType, instanceValue);
			case ConferencePackage.TITLE:
	...
	public Attendee createAttendee() {
		AttendeeImpl attendee = new AttendeeImpl();
		return attendee;
	}
	 ...
	 * @generated
	 */
	public Allergie createAllergie() {
		AllergieImpl allergie = new AllergieImpl();
		return allergie;
	}
	 ...
	 * @generated
	 */
	public Subjects createSubjectsFromString(EDataType eDataType, String initialValue) {
		Subjects result = Subjects.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertSubjectsToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public Allergies createAllergiesFromString(EDataType eDataType, String initialValue) {
		Allergies result = Allergies.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertAllergiesToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
