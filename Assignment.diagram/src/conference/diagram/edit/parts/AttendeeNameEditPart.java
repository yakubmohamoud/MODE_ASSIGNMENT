...
import conference.diagram.edit.policies.ConferenceTextSelectionEditPolicy;
 ...
 * @generated
 */
public class AttendeeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AttendeeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ConferenceTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ConferenceElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConferenceParserProvider.getParser(ConferenceElementTypes.Attendee_2001, getParserElement(),
					ConferenceVisualIDRegistry.getType(conference.diagram.edit.parts.AttendeeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, ConferenceEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
