 ...
 * @generated
 */
public class TableItemSemanticEditPolicy extends ConferenceBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public TableItemSemanticEditPolicy() {
		super(ConferenceElementTypes.Table_2002);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ConferenceVisualIDRegistry.getVisualID(outgoingLink) == SeatEditPart.VISUAL_ID) {
