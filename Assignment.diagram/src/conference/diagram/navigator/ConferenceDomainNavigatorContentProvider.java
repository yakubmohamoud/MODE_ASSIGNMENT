 ...
 * @generated
 */
public class ConferenceDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public ConferenceDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ConferenceDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((ConferenceDomainNavigatorItem) parentElement).getEObject()), parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ConferenceDomainNavigatorItem((EObject) objects[i], parentElement,
