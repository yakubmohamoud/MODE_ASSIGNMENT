...
/**
 * This is the item provider adapter for a {@link conference.Subject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubjectItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subject_subjects_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subject_subjects_feature", "_UI_Subject_type"),
				 ConferencePackage.Literals.SUBJECT__SUBJECTS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Subjects labelValue = ((Subject)object).getSubjects();
