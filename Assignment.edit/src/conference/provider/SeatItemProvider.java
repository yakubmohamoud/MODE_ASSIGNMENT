...
/**
 * This is the item provider adapter for a {@link conference.Seat} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SeatItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConferencePackage.Literals.SEAT__SEAT_ID,
				 true,
				 false,
				 false,
	...
	protected void addOutgoingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Seat_outgoing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Seat_outgoing_feature", "_UI_Seat_type"),
				 ConferencePackage.Literals.SEAT__OUTGOING,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIncomingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Seat_incoming_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Seat_incoming_feature", "_UI_Seat_type"),
				 ConferencePackage.Literals.SEAT__INCOMING,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Seat_type") + " " + seat.getSeatId();
	}
