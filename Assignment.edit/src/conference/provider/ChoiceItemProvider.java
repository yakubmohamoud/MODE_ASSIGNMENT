...
/**
 * This is the item provider adapter for a {@link conference.Choice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChoiceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Choice_attendee_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Choice_attendee_feature", "_UI_Choice_type"),
				 ConferencePackage.Literals.CHOICE__ATTENDEE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addChoicesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Choice_choices_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Choice_choices_feature", "_UI_Choice_type"),
				 ConferencePackage.Literals.CHOICE__CHOICES,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Choices labelValue = ((Choice)object).getChoices();
