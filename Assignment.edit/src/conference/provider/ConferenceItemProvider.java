...
/**
 * This is the item provider adapter for a {@link conference.Conference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConferenceItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConferencePackage.Literals.CONFERENCE__ATTENDEE);
			childrenFeatures.add(ConferencePackage.Literals.CONFERENCE__TABLE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConferencePackage.Literals.CONFERENCE__ATTENDEE,
				 ConferenceFactory.eINSTANCE.createAttendee()));

		newChildDescriptors.add
			(createChildParameter
				(ConferencePackage.Literals.CONFERENCE__TABLE,
				 ConferenceFactory.eINSTANCE.createTable()));
	}
